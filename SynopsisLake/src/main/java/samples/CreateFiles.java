...
public class CreateFiles {
	...
	public CreateFiles(String inputFilePath, String outputFolder, int numberOfFile, int totalNumOfLine) {
		...
		try {
			...
			while (line!= null) {
				...
				if (dataList.size() == dataSizeBound) {
					writeSampleData(outputFolder, fileId, dataList);
	...
	public static void main(String[] args) {
		...
		CreateFiles run = new CreateFiles(inputFilePath, outputFolder, numberOfFile, totalNumOfLine);
	}
